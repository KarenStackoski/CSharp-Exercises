...
namespace Operadores_logicos_entre_variaveis_numericas
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("O valor " + var4 + " é menor ou igual (<=) que " + var5 + "?: " + (var4 <= var5));
            Console.WriteLine("O valor " + var4 + " é maior ou igual (>=) que " + var4 + "?: " + (var4 >= var4));
            Console.WriteLine("O valor " + var5 + " é menor ou igual (<=) que " + var5 + "?: " + (var5 <= var5));
